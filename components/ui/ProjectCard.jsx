  ...
  return (
    ...
    >
      <div className="relative aspect-[4/3] overflow-hidden">
        ...
        <span className="absolute top-4 left-4 rounded-full bg-gold-500 text-navy-900 text-xs font-semibold px-3 py-1">
          {project.category}
        </span>
      </div>
      <div className="p-6">
        ...
        <h3 className="font-display text-lg font-semibold text-white group-hover:text-gold-400 transition-colors">
          {project.title}
        </h3>
